...
<html lang="en">
  ...
  <head>
    ...
    <title>Saundrya Beauty Care</title>
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong>Welcome in Creative World</strong>
            </h1>
            <hr>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="section-heading text-white">Creating a Beautiful World!</h2>
            <hr class="light my-4">
            <p class="text-faded mb-4">The modern Indian woman has many responsibilities, from caring for her family to meeting deadlines at work. And every woman needs a place to escape. Naturals is that place for women. It is an oasis to detox, rejuvenate and relax!</p>
